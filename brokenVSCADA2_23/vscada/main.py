...
`		#Temperature Colour Control
		#if((_motorTemp)>80):
		#  self.lcdNumberMTemp.setStyleSheet(_fromUtf8("background-color: red;"))
		#if(_motorTemp<60):
		#  self.lcdNumberMTemp.setStyleSheet(_fromUtf8("background-color: green;"))
		#if( (_motorTemp >= 60) and (_motorTemp<= 80):
		#  self.lcdNumberMTemp.setStyleSheet(_fromUtf8("background-color: yellow;"))
